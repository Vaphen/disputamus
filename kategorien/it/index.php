...
<article>
	<header>
		<p class="highlight">Ein kleiner Testartikel &uuml;ber IT</p>
	</header>
		Das hier ist ein kleiner Platzhaltertext. Er soll nur einmal
		verdeutlichen, wo spaeter anderer Text steht. Somit soll es mir
		einfach sein, das Design perfekt zu gestalten.
		Das hier ist ein kleiner Platzhaltertext. Er soll nur einmal
		verdeutlichen, wo spaeter anderer Text steht. Somit soll es mir
		einfach sein, das Design perfekt zu gestalten.
		Das hier ist ein kleiner Platzhaltertext. Er soll nur einmal
		verdeutlichen, wo spaeter anderer Text steht. Somit soll es mir
		einfach sein, das Design perfekt zu gestalten.<br />
		Das hier ist ein kleiner Platzhaltertext. Er soll nur einmal
		verdeutlichen, wo spaeter anderer Text steht. Somit soll es mir
		einfach sein, das Design perfekt zu gestalten.
		Das hier ist ein kleiner Platzhaltertext. Er soll nur einmal
	...
	<form method="POST" action="./it.php#commentTable">
			<table id="commentTable">
				<tr>
					...
					<td>
						<input type="text" name="pseudonym" id="pseudonym" class="textfield" maxlength="20" value="<?=htmlentities($_POST['pseudonym'])?>" />
					</td>
				</tr>
				<tr>
					<td class="Label">
					...
					<td>
						...
						<input type="text" name="heading" id="heading" class="textfield" maxlength="50" value="<?=htmlentities($_POST['heading'])?>" />
				...
				<tr>
					...
					<td>		
						<textarea class="textfield" name="content" id="content" maxlength="5000"><?=htmlentities($_POST['content'])?></textarea>
					</td>
				</tr>
			</table>
			<br />
		<input type="submit" value="Kommentar absenden" name="submitComment" id="submitComment" />
	</form>	
</div>
